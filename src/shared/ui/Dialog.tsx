...
export default function Dialog({ isOpen, onClose }: DialogProps) {
    if (!isOpen) return null; // Do not render if the dialog is closed
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg p-6 shadow-lg max-w-md text-center">
          ...
          <p className="text-gray-700 mt-4">
            We are a team of two developers who love watching MrBeast,
            dedicated to providing you with the latest updates on the show.
          </p>
          <p className="text-gray-700 mt-4">
